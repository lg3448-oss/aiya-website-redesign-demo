...
<body class="detail-page product-capability-page" data-detail-kind="${kind}" data-detail-key="${item.key}" data-asset-prefix="../">
  ...
  <script src="../catalog.js?v=20260824-4"></script>
  <script src="../product-pages.js?v=20260824-4"></script>
  <script src="../service-pages.js?v=20260824-4"></script>
  <script src="../mega-menu.js?v=20260824-4"></script>
  <script src="../detail.js?v=20260824-4"></script>
</body>
</html>
`;
};
