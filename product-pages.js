(function initializeProductPages() {
  const profiles = {
    ...
    'Financial Services API Integration': ['financial-services-api-integration', 'Connect software platforms with independent third-party financial service providers through secure APIs and system integrations. AIYA provides software development, API connectivity, data integration, workflow automation, and technical support only. AIYA does not offer, arrange, broker, refer, approve, service, or fund any loan or financing product.', ['API integration', 'Secure data connectivity', 'Workflow automation', 'Testing and technical support']],
