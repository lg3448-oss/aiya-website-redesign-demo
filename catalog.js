  ...
  solutionCategories: [
    {
      ...
      offerings: [
        ...
        { key: 'manufacturing-wholesale', title: 'Manufacturing & Wholesale', description: 'Manufacturers, distributors, warehousing, and logistics.', url: 'solutions/manufacturing-wholesale.html', image: 'assets/service-visual-cloud-operations.jpg', headline: 'Connect commercial and operational systems end to end.', overview: 'Modernize B2B ordering, inventory, data exchange, and operational visibility across manufacturing and wholesale workflows.', capabilities: ['B2B ordering and account experiences', 'Inventory and system integration', 'Operational data and automation'], outcomes: ['Reduce manual order handling', 'Improve partner and inventory visibility', 'Build a foundation for scalable operations'], connected: [{ title: 'B2B Global Commerce', url: 'products/b2b-global-commerce.html' }, { title: 'API & Data Integration', url: 'services/api-data-integration.html' }, { title: 'Finance Data Pipeline', url: 'products/finance-data-pipeline.html' }] },
        { key: 'government-nonprofit', title: 'Government & Nonprofit', description: 'Agencies, nonprofits, associations, and public programs.', url: 'solutions/government-nonprofit.html', image: 'assets/service-visual-strategy-experience.jpg', headline: 'Make public and community services easier to access.', overview: 'Design accessible digital services, secure payment or donation flows, and connected administrative processes for mission-driven organizations.', capabilities: ['Accessible service experiences', 'Payments, donations, and registration', 'Case and administrative workflows'], outcomes: ['Improve access for constituents and supporters', 'Reduce fragmented administrative work', 'Create clearer program visibility'], connected: [{ title: 'Product & Experience Design', url: 'services/product-experience-design.html' }, { title: 'Payment Links', url: 'products/smart-payment-links.html' }, { title: 'Enterprise Platforms', url: 'services/enterprise-platforms.html' }] }
      ]
    },
    {
